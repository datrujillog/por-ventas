...
<head>
    ...
    <meta name="description" content="Aqui en SpochStudios, podras contratar el mejor servicio de desarrollo
    web para la creacion de tu pagina web o la de tu negocio">
    ...
    <section class="inner-banner">
        <div class="w3l-breadcrumb py-5">
            <div class="container py-xl-5 py-md-4 mt-5">
                <h4 class="inner-text-title font-weight-bold mb-sm-2">Acerca de</h4>
                ...
                <div class="row top-cont-grid align-items-center">
                    ...
                    <div class="col-lg-6 text-6-info mb-lg-0 mb-5 pl-xl-5 order-lg-last order-first">
                        ...
                        <p>Sómos una pequeña sociedad de emprendedores talentosos, desarrolladores; que búscan de ayudarte a crecér a nivel profesional y hacer crecér tu negócio, tu marcar.
                           <br>
                           buscamos la oportunidad de participar en un entorno colaborativo, competitivo e inventivo donde utilizar nustra experiencia en diseño y desarrollo web, así como desarrollar nuestro potencial en el desarrollo empresarial, hacer que nuestros conocimientos estén siempre actualizados para estar al día con las nuevas tecnologías..
                        </p>
                        <p class="mt-4">Y que estás esperando para crecer con nosótros?.</p>
                        <a href="services.php" class="btn btn-style mt-lg-5 mt-4 raya"  >Me interéza</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- <section class="home-services py-5">
        <div class="container py-md-5 py-4">
            <div class="section-heading text-center mb-5">
                <h5 class="small-title-2">Nuestros planes</h5>
                <h3 class="title-style-2">¿Por qué escogernos?</h3>
            </div>
            <div class="row justify-content-center">
                <div class="box-wrap col-lg-4 col-md-6">
                    <div class="box-wrap-grid text-center">
                        ...
                        <div class="info">
                            <h4><a href="services.php">Plan <strong>Bronce</strong></a></h4>
                        </div>
                        <p class="mt-3">Ofrecemos cobertura limitada a lo necesário para pequeños empresarios.</p>
                    </div>
                </div>
                <div class="box-wrap col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="box-wrap-grid text-center">
                        ...
                        <div class="info">
                            <h4><a href="services.php">Plan <strong>Oro</strong></a></h4>
                        </div>
                        <p class="mt-3">Ofrecemos Hosting y Domínio de bajo costo.</p>
                    </div>
                </div>
                <div class="box-wrap col-lg-4 col-md-6 mt-lg-0 mt-md-5 mt-4">
                    <div class="box-wrap-grid text-center">
                        ...
                        <div class="info">
                            <h4><a href="services.php">Plan <strong>Diamante</strong></a></h4>
                        </div>
                        <p class="mt-3">Ofrecemos planes de cobertura mensual.</p>
                    </div>
                </div>
                <div class="box-wrap col-lg-4 col-md-6 mt-lg-0 mt-md-5 mt-4">
                    <div class="box-wrap-grid text-center">
                        ...
                        <div class="info">
                            <h4><a href="services.php">Plan <strong>Platino</strong></a></h4>
                        </div>
                        <p class="mt-3">Ofrecemos planes de cobertura anual.</p>
                    </div>
                </div>
            </div>
        </div>
...
<script src="assets/assets/vendor/typed.js/typed.min.js"></script>
